...
func buildApp(cfg *config.Config) (app, error) {
	...
	notifierConfig := provideNotifyConfig(cfg)
	notifier := provideNotifier(system, assetService, messageStore, vaultStore, collateralStore, userStore, flipStore, localizer, notifierConfig)
	...
	staterStater := stater.New(collateralStore, transactionStore, vaultStore, statStore, flipStore, store, assetService)
	v := provideWorkers(cashierCashier, messengerMessenger, payeePayee, sync, spentSync, sender, syncerSyncer, eventsEvents, keeperKeeper, assignerAssigner, datadogDatadog, staterStater)
